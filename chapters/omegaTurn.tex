...
A sequence is a defined as a region of behavior exhibiting only forward locomotion punctuated by exactly one omega turn in response to a stimuli. 



Discontinuities before and after the omega turn indicate the change in orientation.
