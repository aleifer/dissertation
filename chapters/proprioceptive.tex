...
curved microfluidic channel (also see Supplementary Movie  \ref{movie:prop3}). 
...
change its curvature (also see Supplementary Movie  \ref{movie:prop7}). 
...
\subsection{Supplementary Movie 2}\label{movie:prop2}
...
\subsection{Supplementary Movie 9}\label{movie:prop9}
...
White lines show the boundary of the channel (also see Supplementary Movie  \ref{movie:prop2}). 
...
curvature (blue) (also see Supplementary Movie  \ref{movie:prop9}). (\textbf{d})  Curvature of the posterior body 
