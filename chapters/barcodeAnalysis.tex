...
\end{equation}
where \mathbf{r}_i is the set of locations for fluorophores in the image, $h$ is the point spread function of the optical system, and the star denotes the convolution operation.
