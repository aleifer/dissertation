...
We seek to construct an image that contains the underlying signal $q_f(\mathbf{r})$ but has zero-mean, Gaussian, IID noise. We smooth the dark and background images and subtract and divide them to remove the DC offset and compensate for the spatially varying illumination, respectively,
\begin{equation}
