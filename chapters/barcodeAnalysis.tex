...
Eq. \ref{eq:project} provides us with three one-dimensional projections of the barcode intensity with average peak heights of unity, and identicially independentaly distributed zero-mean gaussian noise. These projections are now ready to be compared to a reference. 
