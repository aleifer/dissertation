...
At the very end we will show that the background noise is zero-mean, gaussian, and IID.

Transition to one dimensional problem. 
...
How we take the real data, process it, threshold, find the barcodes.  Could talk about gaussian neoise here

Project it to one dimension. THen run the thing.
