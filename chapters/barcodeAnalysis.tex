...
\section{Results}
The software successfully locates and decodes a variety of barcodes (See Figure \ref{fig:fittedBarcodes}). We examined a total of five images containing 260 fluorescently labeled objects matching the criteria in Table \ref{table:morphCriteria}. For each barcode, we compare the software In all cases a human first visually inspected  barcode and recorded the human's 
