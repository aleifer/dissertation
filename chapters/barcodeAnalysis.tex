...
% f(x) = reduced observed data (offset removed and scale flattened)
...
\begin{equation}
p(f|m_k)\sim p(f-m_k) = \frac{1}{  \sqrt{ (2\pi)^K \det || R_n||} } \exp\left\{ -\frac{1}{2}  (f-m_k)^T R_n^{-1} (f-m_k) \right\}
\end{equation}
